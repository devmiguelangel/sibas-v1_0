			...
			<div class="da-panel collapsible" style="width:700px;">
				<div class="da-panel-header">
					<span class="da-panel-title">
						...
						<b>'.$regief['nombre'].'</b> - <span lang="es">Administrar preguntas Vida en Grupo</span> 
					</span>
				</div>
