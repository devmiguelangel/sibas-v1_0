<?php
function trd_cp_certificate($link, $row, $rsDt, $url, $implant, $fac, $reason = '') {
	$conexion = $link;
	...
	$dir_cia = $url.'images/'.$row['cia_logo'];
	$dir_logo = $url.'images/'.$row['ef_logo'];   
	//$ancho = $imagen[0];            
    //$alto = $imagen[1];
...
<div id="container-main" style="<?=$width_ct;?> height: auto; padding: 5px;">
   <div id="container-cert" style="<?=$width_ct2;?> font-weight: normal; font-size: 80%; font-family: Arial, Helvetica, sans-serif; color: #000000;">
     ...
     <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; <?=$fontSize;?>">
         <tr>
           <td style="width:34%;">
              <img src="<?=$dir_logo;?>" height="60"/>
           </td>
           <td style="width:32%;"></td>
           <td style="width:34%; text-align:right;">
              <img src="<?=$dir_cia;?>" height="60"/>
           </td>
         </tr>
	 ...
	 ?>
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; <?=$fontSize;?>">
             ...
             <tr>
               ...
               <td style="width:25%; text-align:center;"><?=$row['cl_materno'];?></td>
               <td style="width:25%; text-align:center;"><?=$row['cl_nombre'];?></td>
               <td style="width:25%; text-align:center;"><?=$row['cl_ap_casada'];?></td>
             </tr>
              <tr style="font-weight:bold;">
             ...
             <tr>
               <td style="width:25%; text-align:center;"><?=$row['cl_avc'];?></td>
               <td style="width:25%; text-align:center;"><?=$row['cl_direccion'];?></td>
               <td style="width:25%; text-align:center;"><?=$row['cl_no_domicilio'];?></td>
               <td style="width:25%; text-align:center;"><?=$row['cl_localidad'];?></td>
             </tr>
             <tr style="font-weight:bold;">
             ...
             <tr>
               <td style="width:25%; text-align:center;"><?=$row['cl_tel_domicilio'];?></td>
               <td style="width:25%; text-align:center;"><?=$row['cl_tel_oficina'];?></td>
               <td style="width:50%; text-align:center;" colspan="2"><?=$row['cl_tel_celular'];?></td>
             </tr>
             <tr style="font-weight:bold;">
	 ...
	 ?>
          <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; <?=$fontSize;?>">
             ...
             <tr>
               <td style="width:50%; text-align:center;"><?=$row['cl_razon_social'];?></td>
               <td style="width:50%; text-align:center;"><?=$row['cl_ci'];?></td>
             ...
             <tr>
               <td style="width:50%; text-align:center;"><?=$row['cl_tel_oficina'];?></td>
     ...
     <div style="width: auto; height: auto; text-align: left; margin: 7px 0; padding: 0; font-weight: bold; <?=$fontsizeh2;?>">Interés Asegurado - Ubicación del Riesgo</div>
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; <?=$fontSize;?>">
			...
			?>
                ...
                <tr>
                 <td style="width:25%; text-align:center;"><?=$rowDt['pr_tipo'];?></td>
                 <td style="width:25%; text-align:center;"><?=$rowDt['pr_uso'];?></td>
                 <td style="width:25%; text-align:center;"><?=$rowDt['pr_estado'];?></td>
                 <td style="width:25%; text-align:center;"><?=number_format($rowDt['pr_valor_asegurado'],2,".",",");?></td>
                </tr>
                <tr>
                ...
                <tr> 
                 <td style="width:25%; text-align:center;"><?=$rowDt['pr_departamento'];?></td>
                 <td style="width:25%; text-align:center;"><?=$rowDt['pr_zona'];?></td>
                 <td style="width:25%; text-align:center;"><?=$rowDt['pr_localidad'];?></td>
                 <td style="width:25%; text-align:center;"><?=$rowDt['pr_direccion'];?></td>
                </tr> 
            <?php
			  }
			?>
     ...
     <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; <?=$fontSize;?>">
         <tr>
           ...
           <td style="width:50%;"><?=$row['cia_nombre'];?></td>
         </tr>
         <tr>
...
Todo Riesgo de Da&ntilde;os a la Propiedad incluyendo cl&aacute;usula de terremoto, temblor, erupciones volc&aacute;nicas y movimientos s&iacute;smicos al igual que el incendio resultante de estos; incluyendo da&ntilde;os para cubrir p&eacute;rdidas y da&ntilde;os directos ocasionados por derrumbe, deslizamiento y asentamiento, cl&aacute;usula para cubrir p&eacute;rdidas y da&ntilde;os por corrimiento de tierra, cl&aacute;usula para cubrir p&eacute;rdidas y/o da&ntilde;os directos ocasionados por ca&iacute;da de rocas, seguro para motines y/o huelgas y/o conmoci&oacute;n civil y/o vandalismo, sabotaje y terrorismo LPO437, hasta el valor asegurado en la p&oacute;liza, que es igual al saldo deudor del cliente al momento del siniestro. Para valores asegurados superiores a $us. 4.000.000,00 se deber&aacute; consultar a la compa&ntilde;&iacute;a.<br/>
    ...
    De acuerdo al Condicionado General de Seguros y Reaseguros Credinform International S.A., para seguro Todo Riesgo de Da&ntilde;os a la Propiedad.<br/><br/>
            ...
            <ol style="<?=$marginUl;?> list-style-type:lower-alpha;">
             ...
             <tr>
               <td style="text-align:center; width:33%;"><?=$row['cl_nombre'].' '.$row['cl_paterno'].' '.$row['cl_materno']?></td>
               <td style="text-align:center; width:34%;"><?=$row['cl_ci']?></td>
